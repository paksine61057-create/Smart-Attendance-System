...
export type AttendanceType = 'arrival' | 'departure' | 'duty' | 'sick_leave' | 'personal_leave' | 'other_leave';
...
export interface CheckInRecord {
  ...
  status: 'On Time' | 'Late' | 'Normal' | 'Early Leave' | 'Duty' | 'Sick Leave' | 'Personal Leave' | 'Other Leave';
