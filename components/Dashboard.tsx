      ...
      <div className="bg-white rounded-[3.5rem] shadow-2xl border-4 border-rose-50 overflow-hidden min-h-[600px] animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
        ...
        {activeTab === 'official' && (
          <div className="p-0 md:p-3 bg-stone-200 min-h-screen relative overflow-auto">
             ...
             <div className="mx-auto bg-white shadow-2xl px-[8mm] py-[5mm] border border-stone-200 overflow-hidden print-page-a4" style={{ width: '210mm', height: '296mm', pageBreakAfter: 'always', breakInside: 'avoid', boxSizing: 'border-box' }}>
                <div className="flex flex-col items-center text-center mb-2">
                   <img src={SCHOOL_LOGO_URL} alt="School Logo" className="w-10 h-10 object-contain mb-0.5" />
                   <h1 className="text-[11px] font-black text-stone-900 leading-none uppercase">รายงานการมาปฏิบัติงานของครูและบุคลากรทางการศึกษา</h1>
                   <h1 className="text-[11px] font-black text-stone-900 leading-none uppercase">โรงเรียนประจักษ์ศิลปาคม</h1>
                   ...
                   <table className="w-full border-collapse border border-stone-400">
                      <thead>
                         <tr className="bg-stone-50">
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-7">ลำดับ</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-46">รายชื่อ</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-34">ตำแหน่ง</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-12">เวลามา</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-12">เวลากลับ</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center">หมายเหตุ</th>
                         </tr>
                      </thead>
                      <tbody style={{ fontSize: '8px' }}>
                         {officialData.map(d => (
                            <tr key={d.no} className="hover:bg-stone-50/50">
                               <td className="border border-stone-400 py-0.5 px-0.5 text-center font-mono">{d.no}</td>
                               <td className="border border-stone-400 py-0.5 px-1.5 text-left font-bold text-stone-800 whitespace-nowrap">{d.name}</td>
                               <td className="border border-stone-400 py-0.5 px-0.5 text-center text-stone-500 whitespace-nowrap">{d.role}</td>
                               <td className="border border-stone-400 py-0.5 px-0.5 text-center whitespace-nowrap">{d.arrival}</td>
                               <td className="border border-stone-400 py-0.5 px-0.5 text-center whitespace-nowrap">{d.departure}</td>
                               <td className="border border-stone-400 py-0.5 px-1.5 text-left text-stone-500 leading-tight text-[7.5px]">{d.remark}</td>
                            </tr>
                         ))}
                      </tbody>
                   </table>
                </div>
                <div className="mt-4 flex justify-around px-8 py-1">
                   <div className="text-center">
                      <p className="text-[8px] text-stone-800 mb-0.5 font-bold">(ลงชื่อ)...........................................................</p>
                      <p className="text-[8px] font-black text-stone-400 uppercase">กลุ่มบริหารงานบุคคล</p>
                   </div>
                   <div className="text-center">
                      <p className="text-[8px] text-stone-800 mb-0.5 font-bold">(ลงชื่อ)...........................................................</p>
                      <p className="text-[8px] font-black text-stone-400 uppercase">ผู้อำนวยการโรงเรียนประจักษ์ศิลปาคม</p>
                   </div>
                </div>
             </div>
          </div>
        ...
        {activeTab === 'monthly' && (
          <div className="p-0 md:p-3 bg-stone-200 min-h-screen relative overflow-auto">
             ...
             <div className="mx-auto bg-white shadow-2xl px-[8mm] py-[5mm] border border-stone-200 overflow-hidden print-page-a4" style={{ width: '210mm', height: '296mm', pageBreakAfter: 'always', breakInside: 'avoid', boxSizing: 'border-box' }}>
                <div className="flex flex-col items-center text-center mb-2">
                   <img src={SCHOOL_LOGO_URL} alt="School Logo" className="w-10 h-10 object-contain mb-0.5" />
                   <h1 className="text-[11px] font-black text-stone-900 leading-none uppercase">รายงานสถิติการมาปฏิบัติงานรายเดือน</h1>
                   <h1 className="text-[11px] font-black text-stone-900 leading-none uppercase">โรงเรียนประจักษ์ศิลปาคม</h1>
                   ...
                   <table className="w-full border-collapse border border-stone-400">
                      <thead>
                         <tr className="bg-stone-50">
                            ...
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-46">รายชื่อ</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-34">ตำแหน่ง</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-16">ไม่ลงเวลา</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center w-16">มาสาย</th>
                            <th className="border border-stone-400 p-0.5 text-[8.5px] font-black text-center">วันที่ที่มาสาย</th>
                         </tr>
                      </thead>
                      <tbody style={{ fontSize: '8px' }}>
                         {monthlyLatenessData.map(d => (
                            <tr key={d.no} className="hover:bg-stone-50/50">
                               ...
                               <td className="border border-stone-400 py-0.5 px-1.5 text-left font-bold text-stone-800 whitespace-nowrap">{d.name}</td>
                               <td className="border border-stone-400 py-0.5 px-0.5 text-center text-stone-500 whitespace-nowrap">{d.role}</td>
                               <td className={`border border-stone-400 py-0.5 px-0.5 text-center whitespace-nowrap ${d.absentCount > 0 ? 'text-orange-600 font-black' : 'text-stone-300'}`}>{d.absentCount || '-'}</td>
                               <td className={`border border-stone-400 py-0.5 px-0.5 text-center whitespace-nowrap ${d.lateCount > 0 ? 'text-rose-600 font-black' : 'text-stone-300'}`}>{d.lateCount || '-'}</td>
                               <td className="border border-stone-400 py-0.5 px-1.5 text-left text-stone-500 italic text-[7.5px] leading-tight break-all">{d.lateDates}</td>
                            </tr>
                         ))}
                      </tbody>
                   </table>
